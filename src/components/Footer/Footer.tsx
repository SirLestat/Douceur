const Footer = () => {
  return (
    <div className="pt-16 pb-4">
      <footer className="footer bg-[#ffffff] text-base-content p-10 rounded-3xl grid grid-cols-2 md:flex md:justify-around ">
        <div className="col-span-2 flex items-center flex-col md:items-start">
          ...
          <p className="text-[#6B7B64] mt-2  md:text-left">
