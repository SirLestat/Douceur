      ...
      <footer className="footer bg-[#F2F7F2] p-10 rounded-3xl grid grid-cols-2 md:flex md:justify-around">
        <div className="col-span-2 flex items-center flex-col md:items-start">
          <img
            ...
            loading="lazy"
          />
          <p className="text-[#2E6B34] text-3xl font-bold">Douceur</p>
        ...
        <nav>
          <h6 className="footer-title text-[#2E6B34]">Services</h6>
        ...
        <nav>
          <h6 className="footer-title text-[#2E6B34]">Company</h6>
        ...
        <nav>
          <h6 className="footer-title text-[#2E6B34]">Social</h6>
